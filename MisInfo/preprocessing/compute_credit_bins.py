'''
We seperate this bin-forming into its own script because offline feature extraction could be an expensive operation
Just for good software engineering practice :)
'''
